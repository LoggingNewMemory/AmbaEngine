...
resetprop -n debug.sf.high_fps_late_phase_offset_ns 1250000
...
# Done
sleep 1
sed -Ei 's/^description=(\[.*][[:space:]]*)?/description=[⚙️ AmbaEngine Starting] /g' "$MODDIR/module.prop"
su -lp 2000 -c "cmd notification post -S bigtext -t 'AmbaEngine' tag '⚙️ AmbaEngine Starting'" >/dev/null 2>&1
