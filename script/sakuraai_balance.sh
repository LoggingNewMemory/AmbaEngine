...
echo "1750000" > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq
echo "1750000" > /sys/devices/system/cpu/cpu1/cpufreq/scaling_min_freq
echo "1750000" > /sys/devices/system/cpu/cpu2/cpufreq/scaling_min_freq
echo "1750000" > /sys/devices/system/cpu/cpu3/cpufreq/scaling_min_freq
...
echo "1750000" > /sys/devices/system/cpu/cpu4/cpufreq/scaling_min_freq
echo "1750000" > /sys/devices/system/cpu/cpu5/cpufreq/scaling_min_freq
echo "1650000" > /sys/devices/system/cpu/cpu6/cpufreq/scaling_min_freq
echo "1650000" > /sys/devices/system/cpu/cpu7/cpufreq/scaling_min_freq
...
echo "1750000" > /sys/devices/system/cpu/cpu1/cpufreq/scaling_max_freq
echo "1750000" > /sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq
echo "1750000" > /sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq
...
echo "1750000" > /sys/devices/system/cpu/cpu4/cpufreq/scaling_max_freq
echo "1750000" > /sys/devices/system/cpu/cpu5/cpufreq/scaling_max_freq
echo "1650000" > /sys/devices/system/cpu/cpu6/cpufreq/scaling_max_freq
echo "1650000" > /sys/devices/system/cpu/cpu7/cpufreq/scaling_max_freq
...
echo "1650000" > /sys/devices/system/cpu/cpufreq/policy6/scaling_max_freq
...
echo " •> AmbaEngine Normal activated at $(date "+%H:%M:%S")" >> $LOG

# Report
sed -Ei 's/^description=(\[.*][[:space:]]*)?/description=[🐱 AmbaEngine Running] /g' "$BASEDIR/module.prop"
am start -a android.intent.action.MAIN -e toasttext "🐱 AmbaEngine Normal" -n bellavita.toast/.MainActivity
